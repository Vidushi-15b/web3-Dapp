      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore the crypto world. Buy and sell cryptocurrencies easily on Wallet.
          </p>
         {!currentAccount && (
         <button
          type="button"
...
<div className="flex justify-between item-start">
  <div className='w-10 h-10 rounded-full border-2 border-black flex justify-center items-center'>
    <SiEthereum fontSize={24} color='#000000'/>
  </div>
  <BiInfoCircle fontSize={17} color='#000000'/>
</div>
<div>
...
{isLoading ? (
 ...
 className='text-white w-full mt-2 border-[1px] p-2 border-[#3d4e7c] rounded-full cursor-pointer'
 >
  Send Now
 </button>
)}
